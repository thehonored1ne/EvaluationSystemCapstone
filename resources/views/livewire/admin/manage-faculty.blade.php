...
new #[Layout('components.layouts.app')] #[Lazy] class extends Component {
    ...
    {
        return view('livewire.placeholders.manage-faculty-skeleton');
    }
    ...
    public function createUser()
    {
        ...
        \Flux::toast(
            heading: 'Faculty Created',
            text: 'The faculty account has been successfully created.',
            variant: 'success'
        );
    }
    ...
    public function updateUser()
    {
        ...
        $this->showModal = false;
        \Flux::toast(
            heading: 'Faculty Updated',
            text: 'The faculty account has been successfully updated.',
            variant: 'success'
        );
    }
...
<div class="w-full flex flex-col gap-6">
    <div class="flex justify-between items-center">
        <flux:heading size="xl" level="1">Manage Faculty</flux:heading>
        <flux:button variant="primary" wire:click="prepareCreate" icon="plus">Create Faculty</flux:button>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-zinc-400">
                                No faculty accounts found matching your criteria.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div class="bg-white dark:bg-zinc-900 p-6 rounded-lg shadow-xl w-full max-w-lg border border-zinc-200 dark:border-zinc-700 overflow-y-auto max-h-[90vh]">
            <flux:heading size="lg" class="mb-4">{{ $editingUser ? 'Edit Faculty' : 'Create Faculty' }}</flux:heading>
            ...
            <form wire:submit="{{ $editingUser ? 'updateUser' : 'createUser' }}" class="flex flex-col gap-4">
                ...
                <flux:input wire:model="employee_number" label="Employee Number" type="text" placeholder="e.g. FAC-001" required />
