<div class="w-full flex flex-col gap-6">
    ...
    <div class="flex border-b border-zinc-200 dark:border-zinc-800 gap-2 md:gap-4 overflow-x-auto pb-0">
        <div class="pb-3 text-xs md:text-sm font-bold border-b-2 border-[#9b0000] dark:border-[#e07a7a] px-2 text-[#9b0000] dark:text-[#e07a7a]">Student</div>
    ...
    <div class="space-y-6">
        @for ($p = 0; $p < 3; $p++)
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-xs space-y-4 border-l-[5px] border-l-[#9b0000] dark:border-l-[#e07a7a]">
