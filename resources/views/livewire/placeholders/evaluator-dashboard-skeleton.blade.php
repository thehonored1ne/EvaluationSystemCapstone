<div class="flex flex-col gap-6 sm:gap-8 w-full max-w-6xl mx-auto px-1.5 sm:px-3 md:px-4 py-3 sm:py-6">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 sm:p-6 shadow-sm">
        <div class="space-y-2">
    ...
    <!-- Main Card Container -->
    <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 sm:p-5 shadow-xs space-y-5">
