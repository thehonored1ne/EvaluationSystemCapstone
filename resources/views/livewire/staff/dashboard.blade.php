...
<div @if($this->hasProcessing) wire:poll.2500ms="checkProcessingStatus" @endif class="flex flex-col gap-6 sm:gap-8 w-full max-w-6xl mx-auto px-0 sm:px-3 md:px-4 py-3 sm:py-6">
    @if(!$showForm)
        <!-- Header -->
