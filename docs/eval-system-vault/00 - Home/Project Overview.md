...
- **Global Typography (Plus Jakarta Sans & JetBrains Mono)**: Established strict two-font hierarchy with Google Font **Plus Jakarta Sans** for UI chrome, headings, form controls, and navigation, and **JetBrains Mono** for technical data precision, numeric scores, faculty/student IDs, status badges, and timestamps.
